...
const period = document.getElementById('period') as HTMLElement;
const day = document.getElementById('day') as HTMLElement;
const month = document.getElementById('month') as HTMLElement;
